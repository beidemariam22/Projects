...
void print_array(unsigned char *array, unsigned int size) {
  ...
  // enable/disable debug printing with a compile time switch. This compile
  // time switch should be enabled with a VERBOSE flag in the makefile (
  // -DVERBOSE ). If enabled, the print_array function should print as normal.
  // If not defined, nothing should print. Additionally, you need to modify
  // your use of printf to use the PRINTF macro defined in platform.h
  #ifdef VERBOSE
  PRINTF("Array:\n");
